...
| #   | Status      | Feature                                                                                                                                                                                                                                                                                                                                                                            | Hours |
| --- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| 47  | in-progress | **Proposal schema v2 (kind-aware + constraints)** — each issue declares `kind: text\|css\|component\|asset` plus a `constraints: { preserves[], within{} }` block. Redesigner emits multi-kind atomic issues. Enables "copy change + font-size reduction, preserving 3-line desktop hero" as ONE unit.                                                                             | 2     |
