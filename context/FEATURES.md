...
| 46  | in-progress | **Baseline promoter** — on sustained `improved` (default N=2 weeks): update baseline pointer to current sha, archive superseded baseline, log promotion event. Each promotion tightens the next week's bar.                                                                                                                                                                        | 1     |
