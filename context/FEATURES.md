...
- **Done**: 33 (incl. #5 live run artifacts, #38 site/ fork shipped session 4, #39b runtime gate, #39c critic rerun gate, #39d PR emission plan, #39e CF preview wiring, #40a visual asset schema, #40b image backend, #50 planner agent spec, and #51 memory substrate shipped)
- **In-progress**: 0
- **Blocked**: 5 (demo video — Richie voice)
- **Cut**: 7 (out of submission scope; rationale inline)
- **Todo**: 23 (1 submission form + 3 Layer 8 + 9 Layer 9 + 3 Layer 10 + 7 Layer 11; all pre-submission per session-4 Phase 7 scope update + Q1–Q9 locks)
...
| 40c | in-progress | **Brand-context input + persistence** — JSON brand-context blob from `context/business.md` + palette file (Q3). Assets to `site/public/assets/generated/<week>/<type>-<slug>.<ext>`; gitignored dedup cache at `.webster/generated-cache/`.                                                                                                                                                                                                                                                                                                                                               | 2     |
